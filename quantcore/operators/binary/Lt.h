// Lt.h — Element-wise less-than (逐元素小于比较)
// Phase: 一期必实现
//
// Mathematical form:  z_i = 1.0 if x_i < y_i else 0.0
// Reference:  numpy.less (as float)
//
...
struct LtOp : public BinaryOperator<LtOp> {
    static constexpr BinaryOpCode kOpCode = BinaryOpCode::LT;
