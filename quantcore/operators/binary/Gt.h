// Gt.h — Element-wise greater-than (逐元素大于比较)
// Phase: 一期必实现
//
// Mathematical form:  z_i = 1.0 if x_i > y_i else 0.0
// Reference:  numpy.greater (as float)
//
...
//   +Inf > any   -> true  (1.0) except NaN and +Inf
//   -Inf > any   -> false (0.0)
...
struct GtOp : public BinaryOperator<GtOp> {
    static constexpr BinaryOpCode kOpCode = BinaryOpCode::GT;
